...
<title>Registrar Notificación de Descargo | Municipalidad de Ica</title>
...
<div class="container" style="width: 100%; height: 100%; margin: 0%; padding: 0%">
	<header class="header" style="  margin: 1% 18% 0 18%; height: 200px; width: 100%">
		...
		<div class="izquierda" style=" width: 65%; height: 100%; float: right;">
				<h4 style="font-family:serif ; color: #6B0D0D; margin: 7% 0 0 6%; font-size:200%; ;">Generar Notificación de Descargo de Denuncia</h4>
		...
		<div class="inferior" style=" width: 100%; height: 78%; background-color: #DEDEDE; border: 1px solid;" >
		 		...
		 		<div class="cuarto" style="width: 100%; height: 40% ">
		 			...
		 			<div style=" width: 100%; height: 100%">
							...
							<textarea name="comentarios" rows="10" cols="120" style="margin: 2% 0 0 3%" placeholder="Se mostrará los detalles descritos por el cual se están aceptando/rechazando los Documentos complementarios"></textarea>
			...
			<div class="izquierda" style="width: 50%;  height: 15%; float: left; margin-left: 0">
				...
				<div style="width: 98%; height: 7%">
				<h5 style="margin: 3% 0 0 2%; float: left;">Dirección:</h5>
				<input type="text" size="27" value=""  style="margin: 3% 9px 0 0; float: right;" >
				</div>
			...
			<hr style="margin: 13% 1% 0 1%" color="#000000">
		 			...
		 			<div style=" width: 100%; height: 100%">
							...
							<textarea name="comentarios" rows="9" cols="100" style="margin: 2% 0 0 3%" placeholder="En este campo, se podrá visualizar por el cualel director de la comisiónde auditoria solicita su Descargo al denunciado"></textarea>
