...
<title>Buscar Resolucion de Solicitud de Denuncia | Municipalidad de Ica</title>
...
<div class="container" style="width: 100%; height: 100%; margin: 0%; padding: 0%; ">
	<header class="header" style="  margin: 2% 20% 0 20%; height: 150px;width:100% ">
		...
		<div class="izquierda" style=" width: 75%; height: 100%; float: right;">
				<h4 style="font-family:serif ; color: #6B0D0D; margin: 7% 0 0 6%; font-size:200%; ">Buscar resolucion de solicitud de denuncia</h4>
				<h5 style="color: #9B9B9B; margin: 0 0 0 4%" >Resolucion de solicitud de denuncia a consultar</h5>
				<hr style="margin: 2% 0 0 2%; color: black" color="#000000">
		</div>
	</header>
	
	<div class="contenido" style="  margin: 0% 20% 0 20%; height: 550px; width: 100%">
		<h3 style="float: left; margin: 2.5% 0 0% 0">Busqueda de resoluciones de denuncia</h3>
		<br>
		<div class="formulario" style="border: 1px solid ;width: 100%; height: 90%; margin: 4% 0 0 0; background-color: #DDDDDD">
				...
				<div style=" width: 100%; height:42%;">
					<h4 style="float: left; margin: 0.5% 0 1% 1% ; color: #000000">Ver todas los resoluciones existentes</h4>
				...
				<div style=" width: 100%; height:65%;">
						...
						<h4 style="float: left; margin: -10px 0 0 2% ; color: #000000">Seleccione resolucion de denuncia</h4>
					  ...
					  <table class="table table-bordered table-striped mb-0" style="border:1px solid blue;">
					    <thead>
					      <tr>
					        ...
					        <th scope="col">Ver Resolución</th>
					      </tr>
					    </thead>
					    <tbody>
					      <tr>
