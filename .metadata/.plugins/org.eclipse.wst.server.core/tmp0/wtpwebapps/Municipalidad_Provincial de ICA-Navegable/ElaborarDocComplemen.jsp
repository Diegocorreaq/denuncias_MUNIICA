...
<style type="text/css">.my-custom-scrollbar {
						position: relative;
						height: 150px;
						width:96%;
						overflow: auto;
...
<title>Elaborar Documento Complementario | Municipalidad de Ica</title>
...
<div class="container" style="width: 100%; height: 100%; margin: 0%; padding: 0%">
	<header class="header" style="  margin: 1% 18% 0 18%; height: 200px; width: 100%">
		...
		<div class="izquierda" style=" width: 65%; height: 100%; float: right;">
				<h4 style="font-family:serif ; color: #6B0D0D; margin: 7% 0 0 6%; font-size:200%; ;">Elaborar Documento complementario</h4>
				<h6 style="color: #9B9B9B; margin: 0 0 0 4%" >Seleccione solicitud y adicione los requerimientos de información adicional a su denuncia</h6>
				<hr style="margin: 2% 0 0 2%; color: black" color="#000000">
		</div>
	</header>
	
	<div class="contenido" style=" margin: 1% 18% 1% 18%; height: 1000px; width: 100%">
	<div style="width: 100%; height: 3%"><h5 style="float: left; margin: 0 0 0 1%">Lista de solicitudes de documentación complementaria</h5></div>
	
		<div class="superior" style="border: 1px solid; width: 100%; height: 55%; background-color: #DEDEDE; ">
			<h5 style="float: left; margin: 0 0 0 1%">Datos del denunciante</h5>
			<hr style="margin: 3% 1% 0 1%" color="#000000">
			<div class="izquierda" style="width: 50%;  height: 24%; float: left;">
				...
				<div style="width: 100%; height: 7%">
				<h5 style="margin: 2% 10% 0 2%; float: left;">DNI:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h5>
				<input type="text" size="25" value="AutoCompletado"  style="margin: 2% 9px 0 0; float: right;" disabled="disabled">
				</div>
				<div style="width: 100%; height: 7%">
				<h5 style="margin: 4% 10% 0 2%; float: left;">Telefono:</h5>
				<input type="text" size="25" value="AutoCompletado"  style="margin: 2% 9px 0 0; float: right;" disabled="disabled">
				</div>
			
				</div>
				
				<div class="derecha" style="width: 50%; height: 24%; float: right;">
				...
				<hr style="margin: 15% 1% 0 1%; color: black" color="#000000">
				<div class="primero" style="width: 100%; height: 5%; ">
		 		...
		 		<div class="segundo" style="width: 100%; height: 20%; ">
		 			...
		 			<h5 style="color: #9B9B9B; margin: 7% 0 0 4%" >Nota:</h5>
		 			<h5 style="color: #9B9B9B; margin: 0 0 0 4% " >En caso de no contar con más Documentos Complementarios, tiene que adjuntar un Documento respondiendo a  la solicituden máximo 7 días hábiles. Caso contrario, se procederá a archivar el Expediente de Denuncia </h5>
		 		
		</div>
		<div style="width: 100%; height: 3%"><h5 style="float: left; margin: 1% 0 0 0%">Ingresar los datos de la solicitud a generar</h5></div> <br>
...
function Registrar() {
	  alert("Documentos cargados con éxito. Deberá esperar 3 días hábiles, para ver el estado de los documentos complementarios adicionales");
	}
</script>
</html>